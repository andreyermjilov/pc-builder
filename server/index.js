...
const componentSchema = {
  processor: row => ({
    ...
    frequency: +row[6] || 0, cores: +row[7] || 0,
  }),
  graphicsCard: row => ({
    name: row[0] || '', price: +row[1] || 0, description: row[2] || '',
    performance: +row[3] || 0, power: +row[4] || 0,
    pcieVersion: row[5] || '', memory: +row[6] || 0,
  }),
  ram: row => ({
    name: row[0] || '', price: +row[1] || 0, description: row[2] || '',
    performance: +row[3] || 0, ramType: row[4] || '',
    frequency: +row[5] || 0, capacity: +row[6] || 0,
  }),
  storage: row => ({
    name: row[0] || '', price: +row[1] || 0, description: row[2] || '',
    performance: +row[3] || 0, interface: row[4] || '',
    capacity: +row[5] || 0,
  }),
  motherboard: row => ({
    name: row[0] || '', price: +row[1] || 0, description: row[2] || '',
    performance: +row[3] || 0, socket: row[4] || '', formFactor: row[5] || '',
    ramType: row[6] || '', supportedInterfaces: row[7] || '', pcieVersion: row[8] || '',
  }),
  case: row => ({
    name: row[0] || '', price: +row[1] || 0, description: row[2] || '',
    performance: +row[3] || 0, supportedFormFactors: row[4] || '',
  }),
  cooler: row => ({
    name: row[0] || '', price: +row[1] || 0, description: row[2] || '',
